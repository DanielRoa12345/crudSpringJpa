...
public class ClienteController {
	...
	public ResponseEntity<Resource> verFotos(@PathVariable String filename){
	...
	//Muestra el formulario al usuario - Crear Cliente
	...
	public String editar(@PathVariable(value="id")Long id ,  Map<String ,Object> model,RedirectAttributes flash) {
		...
		if(id>0) {
			...
			if(cliente==null) {
				flash.addFlashAttribute("error", "El Id del Cliente no existe Base De Datos");
				return "redirect:/listar";
			}
	...
	//Enviar en el submit la informacion
	...
	public String eliminar(@PathVariable(value="id")Long id,RedirectAttributes flash) {
		if(id > 0) {
			...
			if (uploadFileService.delete(cliente.getFoto())) {
				...
				flash.addFlashAttribute("info", "Foto : " + cliente.getFoto()+"Elimada la imagen con exito "); 
			}
		}
